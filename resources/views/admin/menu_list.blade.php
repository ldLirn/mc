...
<body style=" background-color: gainsboro;">
    ...
    <div style="margin:0px; background-color: white; margin:0 10px;">
        <blockquote class="layui-elem-quote">
            <button type="button" class="layui-btn layui-btn-small" id="getAll"><i class="fa fa-plus" aria-hidden="true"></i> 添加菜单</button>
    ...
    <script>
        layui.config({
            ...
            btable.set({
                openWait: true,//开启等待框
                elem: '#content',
                url: "{{asset('admin/menu/list')}}", //数据源地址
                pageSize: 10,//页大小
                columns: [{ //配置数据列
                    fieldName: '菜单名', //显示名称
                    field: 'title', //字段名
            ...
            function addTab(id){
                layer.open({
                    ...
                    maxmin: true,
                    type: 2,
                    content: "{{url('admin/menu/edit/')}}"+'/'+id,
                    area: ['90%', '80%']
                });
            }
