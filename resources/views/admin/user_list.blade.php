...
<body style=" background-color: gainsboro;">
    ...
    <div style="margin:0px; background-color: white; margin:0 10px;">
        <blockquote class="layui-elem-quote">
            <button type="button" class="layui-btn layui-btn-small" id="getAll"><i class="fa fa-plus" aria-hidden="true"></i> 添加会员</button>
            <form class="layui-form" style="float:right;">
                <div class="layui-form-item" style="margin:0;">
                    <label class="layui-form-label">名称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="name" placeholder="用户名，邮箱.." autocomplete="off" class="layui-input">
                    </div>
    ...
    <script>
        layui.config({
            ...
            btable.set({
                openWait: true,//开启等待框
                elem: '#content',
                url: "{{asset('admin/users/list')}}", //数据源地址
                pageSize: 10,//页大小
                columns: [{ //配置数据列
                    fieldName: '用户名', //显示名称
                    field: 'name', //字段名
