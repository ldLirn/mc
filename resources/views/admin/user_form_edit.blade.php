	...
	<body>
			...
			<form class="layui-form" action="" enctype="multipart/form-data">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="name" lay-verify="required|name"  value="{{$data['name']}}"  autocomplete="off" class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="nickname" lay-verify=""  value="{{$data['nickname']}}"  autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
								...
								<div class="col-md-12 col-sm-12 col-xs-12" style="padding-right:0;padding-left:36px;">
									...
									<div style="min-height:1px;line-height:160px;text-align:center;position:relative;" ontouchstart="">
										...
										<div class="" style="width:140px;height:32px;border-radius: 4px;background-color:#ff8a00;color: #FFFFFF;font-size: 14px;text-align:center;line-height:32px;outline:none;margin-left:37px;position:relative;">
											...
											<input type="hidden" name="base_img" id="base_img" value="{{$data['head_img']}}">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="email" lay-verify="required|email"  value="{{$data['email']}}"  autocomplete="off" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="qq" lay-verify="required|number"  value="{{$data['qq']}}"  autocomplete="off" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="telphone" lay-verify="required|phone"  value="{{$data['telphone']}}"  autocomplete="off" class="layui-input">
					</div>
				</div>
		...
		<script>
            ...
            var clipArea = new bjj.PhotoClip("#clipArea", {
                ...
                $('#view').css('background','{{$data['head_img']}}');
