	...
	<body>
		<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
				...
				<div class="layui-main">
					<div class="admin-login-box">
						<a class="logo" style="left: 0;" href="{{url('admin')}}">
							<span style="font-size: 22px;">萌宠之家</span>
						</a>
					...
					<ul class="layui-nav admin-header-item">
						...
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
								...
								<span id="username">{{session('users.username')}}</span>
							</a>
							<dl class="layui-nav-child">
								...
								<dd>
									<a href="{{url('admin/out')}}"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a>
								</dd>
							</dl>
						</li>
					</ul>
			...
			<div class="layui-footer footer footer-demo" id="admin-footer">
				<div class="layui-main">
					<p>2017 &copy;
						<a href="http://www.lirn.top">Lirn</a>
					</p>
				</div>
			</div>
